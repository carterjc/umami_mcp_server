...
#     texts, similarity_threshold=0.7, min_chunk_size=100, max_chunk_size=1000
# ):
#     """
...
#                 [similarity_matrix[i][j] for j in range(i - len(current_chunk), i)]
#             )
...
#     second_stage_chunks_per_user = [
#         second_stage_chunking(chunk) for chunk in first_stage_chunks
#     ]
...
# async def get_chunks(user_activity_list, user_question) -> list[Document]:
#     """
...
#         search_type="mmr", search_kwargs={"k": 20, "fetch_k": 5000}
#     )
